...
module Buffer_writer: WRITER with type oc = Buffer_output.oc and type 'a IO.t = 'a
module String_reader: READER with type ic = String_input.ic and type 'a IO.t = 'a
module String_writer: WRITER with type oc = String_output.oc and type 'a IO.t = 'a

module Bulk: sig
  module String(R: READER)(W: WRITER with module IO = R.IO): BULK with module IO = R.IO and module Reader = R and module Writer = W and type bulk = string
end
